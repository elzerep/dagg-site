  ...
  <div class="w">
    <div class="hero">
      <div class="rv">
        ...
        <p class="lead">Most companies buy AI tools before they understand their own work.</p>
      </div>
      <div class="rv" style="padding-bottom:6px">
        <p class="tx">Dagg starts with the work: how it moves, where it waits, and which parts
          of it are worth changing. Then builds what follows — and runs it, where you would
          rather not.</p>
