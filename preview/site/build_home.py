  ...
  <div class="w">
    ...
    <div class="g">
      <figure class="m7 scroll-x" data-lives>
        <svg class="hg dg" viewBox="0 0 600 300" role="img"
          ...
          <g class="e">
            <path class="edge" d="M104 72 L146 72"/><path class="edge" d="M104 150 L146 150"/><path class="edge" d="M104 228 L146 228"/>
            <path class="edge" d="M258 72 L286 72 Q306 72 306 122 L306 138"/>
            <path class="edge" d="M258 228 L286 228 Q306 228 306 178 L306 162"/>
            <path class="edge" d="M258 150 L306 150"/>
          </g>
          <g class="n">
            <rect class="node" x="0" y="58" width="104" height="28" rx="1"/><text class="lab" x="52" y="76" text-anchor="middle">REQUEST</text>
            <rect class="node" x="0" y="136" width="104" height="28" rx="1"/><text class="lab" x="52" y="154" text-anchor="middle">DOCUMENT</text>
            <rect class="node" x="0" y="214" width="104" height="28" rx="1"/><text class="lab" x="52" y="232" text-anchor="middle">APPROVAL</text>
            <rect class="node" x="146" y="54" width="112" height="36" rx="1"/><text class="lab" x="202" y="76" text-anchor="middle">A PERSON</text>
            <rect class="node" x="146" y="132" width="112" height="36" rx="1"/><text class="lab" x="202" y="154" text-anchor="middle">A SYSTEM</text>
            <rect class="node" x="146" y="210" width="112" height="36" rx="1"/><text class="lab" x="202" y="232" text-anchor="middle">A HANDOFF</text>
          </g>
          <g class="n core"><rect class="node" x="306" y="128" width="80" height="44" rx="1"/>
            <text class="lab" x="346" y="146" text-anchor="middle">WORK</text><text class="lab" x="346" y="160" text-anchor="middle">GRAPH</text></g>
