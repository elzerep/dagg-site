...
Every route has one board-level question, one decision the reader can take, one dominant inspectable object, one semantic motion verb, one explicit boundary and one relevant next action. Supporting pages deepen the homepage; they do not repeat it in longer prose.

The common five-act anatomy is:
...
- **Role:** Executive memo for all of Dagg.
...
- **Role:** Strategic deep dive with McKinsey-like answer-first logic.
...
- **Next action:** Explore WorkGraph or start an assessment.
...
- **Next action:** Explore Impact or start an assessment.

## `/impact` · Impact

- **Role:** Evidence destination answering what became materially different because Dagg was involved.
...
- **Next action:** Read full proof or start an assessment.

## `/company` · Company

- **Role:** Establish mission, conviction, partnership model and accountable leadership without headcount theatre.
- **Question:** What does Dagg believe and who takes responsibility when the work becomes difficult?
- **Decision:** Dagg feels like a discreet, forward-looking and accountable partner.
- **Sequence:** Mission → point of view → four capabilities → partnership model → accountability/confidentiality → dialogue.
- **Primary object:** Partnership Charter: decision rights, responsibilities, escalation, confidentiality and non-negotiables.
- **Motion verb:** `state → assign → commit`.
- **Boundary:** No team wall, employee count or claims that efficiency comes from being small.
- **Next action:** Start an assessment or direct dialogue.

## `/assessment` · Start an assessment

- **Role:** Make the first engagement concrete, bounded and low-risk.
- **Question:** What happens, what will we receive and what are we committing to?
- **Decision:** Initiate a qualified assessment.
- **Sequence:** What it decides → fit / not fit → required evidence and access principles → map/decide/recommend or refuse → Decision Pack → inquiry/confirmation.
- **Primary object:** Assessment Decision Pack preview with operating map, recommendation or refusal, intervention brief, owner, evidence boundary and what would change the decision.
- **Motion verb:** `collect → resolve → assemble → confirm`.
- **Boundary:** It is a decision instrument, not a commitment to build.
- **Next action:** Complete the inquiry.

## `/trust` · Trust

- **Role:** Provide inspectable technical and governance depth linked from Build and the footer.
